module github.com/external-secrets/external-secrets/targets/kubernetes
...
require (
	...
	github.com/external-secrets/external-secrets/targets v0.0.0-00010101000000-000000000000
	k8s.io/api v0.34.2
