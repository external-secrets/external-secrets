...
func (c *FakeExternalSecrets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ExternalSecret, err error) {
	emptyResult := &v1alpha1.ExternalSecret{}
	obj, err := c.Fake.
...
func (c *FakeExternalSecrets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ExternalSecretList, err error) {
	emptyResult := &v1alpha1.ExternalSecretList{}
	obj, err := c.Fake.
...
func (c *FakeExternalSecrets) UpdateStatus(ctx context.Context, externalSecret *v1alpha1.ExternalSecret, opts v1.UpdateOptions) (result *v1alpha1.ExternalSecret, err error) {
	emptyResult := &v1alpha1.ExternalSecret{}
	obj, err := c.Fake.
