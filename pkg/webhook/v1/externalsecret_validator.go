...
var _ admission.Validator[*esv1.ExternalSecret] = &ExternalSecretValidator{}
...
func (in *ExternalSecretValidator) ValidateCreate(_ context.Context, obj *esv1.ExternalSecret) (warnings admission.Warnings, err error) {
	return validateExternalSecret(obj)
}

// ValidateUpdate validates the update of an external secret object.
func (in *ExternalSecretValidator) ValidateUpdate(_ context.Context, _, newObj *esv1.ExternalSecret) (warnings admission.Warnings, err error) {
	return validateExternalSecret(newObj)
}

// ValidateDelete validates the deletion of an external secret object.
func (in *ExternalSecretValidator) ValidateDelete(_ context.Context, _ *esv1.ExternalSecret) (warnings admission.Warnings, err error) {
	return nil, nil
}

func validateExternalSecret(es *esv1.ExternalSecret) (admission.Warnings, error) {
	if es == nil {
...
func validateSourceRef(ref esv1.ExternalSecretDataFromRemoteRef) error {
...
func validateFindExtractSourceRef(ref esv1.ExternalSecretDataFromRemoteRef) error {
...
func validateExtractFindGenerator(ref esv1.ExternalSecretDataFromRemoteRef) error {
...
func validatePolicies(es *esv1.ExternalSecret) error {
	var errs error
	if (es.Spec.Target.DeletionPolicy == esv1.DeletionPolicyDelete && es.Spec.Target.CreationPolicy == esv1.CreatePolicyMerge) ||
		(es.Spec.Target.DeletionPolicy == esv1.DeletionPolicyDelete && es.Spec.Target.CreationPolicy == esv1.CreatePolicyNone) {
	...
	if es.Spec.Target.DeletionPolicy == esv1.DeletionPolicyMerge && es.Spec.Target.CreationPolicy == esv1.CreatePolicyNone {
...
func validateDuplicateKeys(es *esv1.ExternalSecret, errs error) error {
	if es.Spec.Target.DeletionPolicy == esv1.DeletionPolicyRetain {
