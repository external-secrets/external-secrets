...
const (
	...
	errInvalidProvider  = "invalid provider spec. Missing Cerberus field in store %s"
)

// GetCerberusProvider does the necessary nil checks on the generic store
