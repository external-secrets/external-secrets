...
| webhook.certManager.cert.privateKey | object | `{"algorithm":"RSA","rotationPolicy":"Always","size":2048}` | Specific settings on the privateKey and its generation |
...
| webhook.certManager.cert.signatureAlgorithm | string | `"SHA256WithRSA"` | Specific settings on the signatureAlgorithm used on the cert |
