...
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![Version: 0.20.2](https://img.shields.io/badge/Version-0.20.2-informational?style=flat-square)
...
| vault | object | `{"enableTokenCache":false,"tokenCacheSize":0}` | Vault token cache configuration |
...
| vault.tokenCacheSize | int | `0` | Maximum size of Vault token cache. Only used if enableTokenCache is true. |
