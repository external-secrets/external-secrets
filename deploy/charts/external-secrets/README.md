...
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![Version: 1.2.1](https://img.shields.io/badge/Version-1.2.1-informational?style=flat-square)
...
| certController.hostUsers | string | `nil` | Specifies if certController pod should use hostUsers or not. If hostNetwork is true, hostUsers should be too. @schema type: [boolean, null] |
...
| hostUsers | string | `nil` | Specifies if controller pod should use hostUsers or not. If hostNetwork is true, hostUsers should be too. @schema type: [boolean, null] |
...
| webhook.hostUsers | string | `nil` | Specifies if webhook pod should use hostUsers or not. If hostNetwork is true, hostUsers should be too. @schema type: [boolean, null] |
