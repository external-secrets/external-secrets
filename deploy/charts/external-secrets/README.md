...
| crds.createClusterProvider | bool | `false` | If true, create CRDs for Cluster Provider. |
...
| crds.createProvider | bool | `false` | If true, create CRDs for Provider. |
...
| v2 | object | `{"enabled":false}` | Experimental v2 Provider/ClusterProvider support. Keep disabled unless you explicitly opt into v2 provider flows. |
