...
| readinessProbe.enabled | bool | `false` | Enabled determines if the readiness probe should be used or not. By default it's disabled. |
| readinessProbe.spec | object | `{"address":"","failureThreshold":5,"httpGet":{"path":"/readyz","port":8082},"initialDelaySeconds":10,"periodSeconds":10,"successThreshold":1,"timeoutSeconds":5}` | The body of the readiness probe settings. |
| readinessProbe.spec.address | string | `""` | Address for readiness probe. |
| readinessProbe.spec.failureThreshold | int | `5` | Number of consecutive probe failures that should occur before considering the probe as failed. |
| readinessProbe.spec.httpGet | object | `{"path":"/readyz","port":8082}` | Handler for readiness probe. |
| readinessProbe.spec.httpGet.path | string | `"/readyz"` | Path for readiness probe. |
| readinessProbe.spec.httpGet.port | int | `8082` | Set this value to 8082 to active readiness probes. @schema type: [string, integer] |
