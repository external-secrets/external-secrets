...
Read the [deprecation policy reference](contributing/deprecation_policy.md) first.
...
The maintainers will vote to the accept the deprecation, following our [policy](contributing/policy.md#decisions-and-tie-breaking)
