...
func (in *GeneratorSpec) DeepCopyInto(out *GeneratorSpec) {
	*out = *in
	...
	if in.OIDCSpec != nil {
		in, out := &in.OIDCSpec, &out.OIDCSpec
		*out = new(OIDCSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *GrantSpec) DeepCopyInto(out *GrantSpec) {
	*out = *in
	...
	if in.TokenExchange != nil {
		...
		*out = new(TokenExchangeGrantSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *OIDCSpec) DeepCopyInto(out *OIDCSpec) {
	*out = *in
	...
	in.Grant.DeepCopyInto(&out.Grant)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TokenExchangeGrantSpec) DeepCopyInto(out *TokenExchangeGrantSpec) {
	*out = *in
	if in.SubjectTokenRef != nil {
		in, out := &in.SubjectTokenRef, &out.SubjectTokenRef
		*out = new(metav1.SecretKeySelector)
		(*in).DeepCopyInto(*out)
	}
	if in.ServiceAccountRef != nil {
	...
	if in.ActorTokenRef != nil {
		in, out := &in.ActorTokenRef, &out.ActorTokenRef
		*out = new(metav1.SecretKeySelector)
		(*in).DeepCopyInto(*out)
	}
	if in.AdditionalParameters != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TokenExchangeGrantSpec.
func (in *TokenExchangeGrantSpec) DeepCopy() *TokenExchangeGrantSpec {
	if in == nil {
		return nil
	}
	out := new(TokenExchangeGrantSpec)
