...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RoleAssumptionParameters) DeepCopyInto(out *RoleAssumptionParameters) {
	*out = *in
	if in.SessionDuration != nil {
		in, out := &in.SessionDuration, &out.SessionDuration
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RoleAssumptionParameters.
func (in *RoleAssumptionParameters) DeepCopy() *RoleAssumptionParameters {
	if in == nil {
		return nil
	}
	out := new(RoleAssumptionParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *STSAssumeRoleTokenSpec) DeepCopyInto(out *STSAssumeRoleTokenSpec) {
	*out = *in
	in.Auth.DeepCopyInto(&out.Auth)
	if in.RoleAssumptionParameters != nil {
		in, out := &in.RoleAssumptionParameters, &out.RoleAssumptionParameters
		*out = new(RoleAssumptionParameters)
		(*in).DeepCopyInto(*out)
	}
}
