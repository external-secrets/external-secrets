...
func (in *ClusterGeneratorSpec) DeepCopyInto(out *ClusterGeneratorSpec) {
	*out = *in
	if in.ACRAccessToken != nil {
		in, out := &in.ACRAccessToken, &out.ACRAccessToken
		*out = new(ACRAccessToken)
		(*in).DeepCopyInto(*out)
	}
	if in.ECRAuthorizationToken != nil {
		in, out := &in.ECRAuthorizationToken, &out.ECRAuthorizationToken
	...
	if in.GCRAccessToken != nil {
		in, out := &in.GCRAccessToken, &out.GCRAccessToken
		*out = new(GCRAccessToken)
		(*in).DeepCopyInto(*out)
	}
	if in.GithubAccessToken != nil {
		in, out := &in.GithubAccessToken, &out.GithubAccessToken
	...
	if in.STSSessionToken != nil {
		in, out := &in.STSSessionToken, &out.STSSessionToken
	...
	if in.VaultDynamicSecret != nil {
		in, out := &in.VaultDynamicSecret, &out.VaultDynamicSecret
