...
func (in *GeneratorSpec) DeepCopyInto(out *GeneratorSpec) {
	*out = *in
	...
	if in.RDSIAMAuthTokenSpec != nil {
		in, out := &in.RDSIAMAuthTokenSpec, &out.RDSIAMAuthTokenSpec
		*out = new(RDSIAMAuthTokenSpec)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RDSIAMAuthToken) DeepCopyInto(out *RDSIAMAuthToken) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RDSIAMAuthToken.
func (in *RDSIAMAuthToken) DeepCopy() *RDSIAMAuthToken {
	if in == nil {
		return nil
	}
	out := new(RDSIAMAuthToken)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RDSIAMAuthToken) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RDSIAMAuthTokenList) DeepCopyInto(out *RDSIAMAuthTokenList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RDSIAMAuthToken, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RDSIAMAuthTokenList.
func (in *RDSIAMAuthTokenList) DeepCopy() *RDSIAMAuthTokenList {
	if in == nil {
		return nil
	}
	out := new(RDSIAMAuthTokenList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RDSIAMAuthTokenList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RDSIAMAuthTokenSpec) DeepCopyInto(out *RDSIAMAuthTokenSpec) {
	*out = *in
	in.Auth.DeepCopyInto(&out.Auth)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RDSIAMAuthTokenSpec.
func (in *RDSIAMAuthTokenSpec) DeepCopy() *RDSIAMAuthTokenSpec {
	if in == nil {
		return nil
	}
	out := new(RDSIAMAuthTokenSpec)
