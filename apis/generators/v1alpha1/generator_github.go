...
type GithubAccessTokenSpec struct {
	...
	// List of repositories the token will have access to. If ommitted, defaults to all repositories the GitHub App
	// is installed to.
	Repositories []string `json:"repositories,omitempty"`
	// Map of permissions the token will have. If ommitted, defaults to all permissions the GitHub App has.
