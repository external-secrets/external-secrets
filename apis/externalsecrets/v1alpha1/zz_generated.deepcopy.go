...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PushSecretGeneratorState) DeepCopyInto(out *PushSecretGeneratorState) {
	*out = *in
	if in.Latest != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PushSecretGeneratorState.
func (in *PushSecretGeneratorState) DeepCopy() *PushSecretGeneratorState {
	if in == nil {
		return nil
	}
	out := new(PushSecretGeneratorState)
	in.DeepCopyInto(out)
	return out
}
