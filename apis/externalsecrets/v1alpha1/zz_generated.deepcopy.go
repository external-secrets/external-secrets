...
func (in *PushSecretStatus) DeepCopyInto(out *PushSecretStatus) {
	*out = *in
	...
	if in.SyncedPushSecrets != nil {
		...
		*out = make(PushSecretsMap, len(*in))
		for key, val := range *in {
	...
	if in.ExistingPushSecrets != nil {
		in, out := &in.ExistingPushSecrets, &out.ExistingPushSecrets
		*out = make(PushSecretsMap, len(*in))
		for key, val := range *in {
			var outVal map[string]PushSecretData
			if val == nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in PushSecretsMap) DeepCopyInto(out *PushSecretsMap) {
	{
		in := &in
		*out = make(PushSecretsMap, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PushSecretsMap.
func (in PushSecretsMap) DeepCopy() PushSecretsMap {
	if in == nil {
		return nil
	}
	out := new(PushSecretsMap)
	in.DeepCopyInto(out)
	return *out
}
