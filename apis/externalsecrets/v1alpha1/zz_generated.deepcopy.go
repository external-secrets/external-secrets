...
func (in *AzureKVProvider) DeepCopyInto(out *AzureKVProvider) {
	*out = *in
	...
	if in.ActiveDirectoryEndpoint != nil {
		in, out := &in.ActiveDirectoryEndpoint, &out.ActiveDirectoryEndpoint
		*out = new(string)
		**out = **in
	}
	if in.ActiveDirectoryResourceID != nil {
		in, out := &in.ActiveDirectoryResourceID, &out.ActiveDirectoryResourceID
		*out = new(string)
		**out = **in
	}
}
