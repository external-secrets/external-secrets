...
type VaultSecretEngine string

const (
	VaultSecretEngineKeyValue VaultSecretEngine = "kv"
	VaultSecretEngineAWS      VaultSecretEngine = "aws"
)
...
type VaultProvider struct {
	...
	// +kubebuilder:validation:Optional
	// +kubebuilder:validation:Enum="kv";"aws"
	...
	// be either "sts" or "creds". This paremeter is ignored if secretEngine is not `aws`
	// +kubebuilder:validation:Optional
	...
	// "v2". Version defaults to "v2". Ignored when secretEngine is not "kv"
	// +kubebuilder:validation:Optional
