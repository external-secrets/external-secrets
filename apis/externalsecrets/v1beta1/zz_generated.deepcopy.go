...
func (in *SenhaseguraAuth) DeepCopyInto(out *SenhaseguraAuth) {
	*out = *in
	if in.IsoSecretRef != nil {
		in, out := &in.IsoSecretRef, &out.IsoSecretRef
		*out = new(SenhaseguraIsoAuth)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SenhaseguraIsoAuth) DeepCopyInto(out *SenhaseguraIsoAuth) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SenhaseguraIsoAuth.
func (in *SenhaseguraIsoAuth) DeepCopy() *SenhaseguraIsoAuth {
	if in == nil {
		return nil
	}
	out := new(SenhaseguraIsoAuth)
