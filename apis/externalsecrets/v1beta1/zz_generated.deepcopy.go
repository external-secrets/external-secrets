...
func (in *ExternalSecretStatus) DeepCopyInto(out *ExternalSecretStatus) {
	*out = *in
	...
	in.LeaseTimeout.DeepCopyInto(&out.LeaseTimeout)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VaultAWSSecretEngine) DeepCopyInto(out *VaultAWSSecretEngine) {
	*out = *in
	if in.Path != nil {
		in, out := &in.Path, &out.Path
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VaultAWSSecretEngine.
func (in *VaultAWSSecretEngine) DeepCopy() *VaultAWSSecretEngine {
	if in == nil {
		return nil
	}
	out := new(VaultAWSSecretEngine)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VaultKeyValueSecretEngine) DeepCopyInto(out *VaultKeyValueSecretEngine) {
	*out = *in
	if in.Path != nil {
		in, out := &in.Path, &out.Path
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VaultKeyValueSecretEngine.
func (in *VaultKeyValueSecretEngine) DeepCopy() *VaultKeyValueSecretEngine {
	if in == nil {
		return nil
	}
	out := new(VaultKeyValueSecretEngine)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VaultProvider) DeepCopyInto(out *VaultProvider) {
	*out = *in
	in.Auth.DeepCopyInto(&out.Auth)
	in.SecretEngine.DeepCopyInto(&out.SecretEngine)
	if in.Namespace != nil {
		in, out := &in.Namespace, &out.Namespace
		*out = new(string)
		**out = **in
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VaultSecretEngine) DeepCopyInto(out *VaultSecretEngine) {
	*out = *in
	if in.AWS != nil {
		in, out := &in.AWS, &out.AWS
		*out = new(VaultAWSSecretEngine)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VaultSecretEngine.
func (in *VaultSecretEngine) DeepCopy() *VaultSecretEngine {
	if in == nil {
		return nil
	}
	out := new(VaultSecretEngine)
	in.DeepCopyInto(out)
	return out
}
