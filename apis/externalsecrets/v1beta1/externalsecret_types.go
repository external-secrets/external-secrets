...
type GeneratorRef struct {
	...
	// +kubebuilder:validation:Enum=ACRAccessToken;BeyondtrustSecretsDynamicSecret;ClusterGenerator;ECRAuthorizationToken;Fake;GCRAccessToken;GithubAccessToken;QuayAccessToken;Password;SSHKey;STSSessionToken;UUID;VaultDynamicSecret;Webhook;Grafana
