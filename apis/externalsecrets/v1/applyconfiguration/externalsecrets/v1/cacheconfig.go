...
func (b *CacheConfigApplyConfiguration) WithTTL(value metav1.Duration) *CacheConfigApplyConfiguration {
	b.TTL = &value
	return b
}
...
func (b *CacheConfigApplyConfiguration) WithMaxSize(value int) *CacheConfigApplyConfiguration {
	b.MaxSize = &value
	return b
}
