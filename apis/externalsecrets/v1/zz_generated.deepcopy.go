...
func (in *SecretStoreProvider) DeepCopyInto(out *SecretStoreProvider) {
	*out = *in
	...
	if in.TrueFoundry != nil {
		in, out := &in.TrueFoundry, &out.TrueFoundry
		*out = new(TrueFoundryProvider)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrueFoundryAuth) DeepCopyInto(out *TrueFoundryAuth) {
	*out = *in
	if in.SecretRef != nil {
		in, out := &in.SecretRef, &out.SecretRef
		*out = new(TrueFoundryAuthSecretRef)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrueFoundryAuth.
func (in *TrueFoundryAuth) DeepCopy() *TrueFoundryAuth {
	if in == nil {
		return nil
	}
	out := new(TrueFoundryAuth)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrueFoundryAuthSecretRef) DeepCopyInto(out *TrueFoundryAuthSecretRef) {
	*out = *in
	in.ClusterToken.DeepCopyInto(&out.ClusterToken)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrueFoundryAuthSecretRef.
func (in *TrueFoundryAuthSecretRef) DeepCopy() *TrueFoundryAuthSecretRef {
	if in == nil {
		return nil
	}
	out := new(TrueFoundryAuthSecretRef)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrueFoundryProvider) DeepCopyInto(out *TrueFoundryProvider) {
	*out = *in
	in.Auth.DeepCopyInto(&out.Auth)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrueFoundryProvider.
func (in *TrueFoundryProvider) DeepCopy() *TrueFoundryProvider {
	if in == nil {
		return nil
	}
	out := new(TrueFoundryProvider)
