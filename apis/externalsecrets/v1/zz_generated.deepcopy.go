...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WlifAuth) DeepCopyInto(out *WlifAuth) {
	*out = *in
	in.ServiceAccountRef.DeepCopyInto(&out.ServiceAccountRef)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WlifAuth.
func (in *WlifAuth) DeepCopy() *WlifAuth {
	if in == nil {
		return nil
	}
	out := new(WlifAuth)
...
func (in *YandexAuth) DeepCopyInto(out *YandexAuth) {
	*out = *in
	...
	if in.WlifAuth != nil {
		in, out := &in.WlifAuth, &out.WlifAuth
		*out = new(WlifAuth)
		(*in).DeepCopyInto(*out)
	}
}
