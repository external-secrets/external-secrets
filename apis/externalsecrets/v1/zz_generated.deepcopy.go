...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SafeguardA2AAuth) DeepCopyInto(out *SafeguardA2AAuth) {
	*out = *in
	in.Certificate.DeepCopyInto(&out.Certificate)
	if in.CertificateKey != nil {
		in, out := &in.CertificateKey, &out.CertificateKey
		*out = new(SafeguardProviderSecretRef)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SafeguardA2AAuth.
func (in *SafeguardA2AAuth) DeepCopy() *SafeguardA2AAuth {
	if in == nil {
		return nil
	}
	out := new(SafeguardA2AAuth)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SafeguardAuth) DeepCopyInto(out *SafeguardAuth) {
	*out = *in
	if in.A2A != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SafeguardAuth.
func (in *SafeguardAuth) DeepCopy() *SafeguardAuth {
	if in == nil {
		return nil
	}
	out := new(SafeguardAuth)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SafeguardProvider) DeepCopyInto(out *SafeguardProvider) {
	*out = *in
	in.Auth.DeepCopyInto(&out.Auth)
	if in.CABundle != nil {
		in, out := &in.CABundle, &out.CABundle
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SafeguardProvider.
func (in *SafeguardProvider) DeepCopy() *SafeguardProvider {
	if in == nil {
		return nil
	}
	out := new(SafeguardProvider)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SafeguardProviderSecretRef) DeepCopyInto(out *SafeguardProviderSecretRef) {
	*out = *in
	if in.SecretRef != nil {
		in, out := &in.SecretRef, &out.SecretRef
		*out = new(apismetav1.SecretKeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SafeguardProviderSecretRef.
func (in *SafeguardProviderSecretRef) DeepCopy() *SafeguardProviderSecretRef {
	if in == nil {
		return nil
	}
	out := new(SafeguardProviderSecretRef)
...
func (in *SecretStoreProvider) DeepCopyInto(out *SecretStoreProvider) {
	*out = *in
	...
	if in.Safeguard != nil {
		in, out := &in.Safeguard, &out.Safeguard
		*out = new(SafeguardProvider)
		(*in).DeepCopyInto(*out)
	}
