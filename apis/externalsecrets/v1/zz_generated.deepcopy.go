...
func (in *ExternalSecretDataFromRemoteRef) DeepCopyInto(out *ExternalSecretDataFromRemoteRef) {
	*out = *in
	...
	if in.Select != nil {
		...
		*out = make([]ExternalSecretSelect, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalSecretSelect) DeepCopyInto(out *ExternalSecretSelect) {
	*out = *in
	if in.Regexp != nil {
		in, out := &in.Regexp, &out.Regexp
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalSecretSelect.
func (in *ExternalSecretSelect) DeepCopy() *ExternalSecretSelect {
	if in == nil {
		return nil
	}
	out := new(ExternalSecretSelect)
	in.DeepCopyInto(out)
	return out
}
