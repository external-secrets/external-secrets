...
func (in *OvhAuth) DeepCopyInto(out *OvhAuth) {
	*out = *in
	...
	if in.ClientOAuth2 != nil {
		in, out := &in.ClientOAuth2, &out.ClientOAuth2
		*out = new(OvhClientOAuth2)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OvhClientOAuth2) DeepCopyInto(out *OvhClientOAuth2) {
	*out = *in
	in.ClientID.DeepCopyInto(&out.ClientID)
	in.ClientSecret.DeepCopyInto(&out.ClientSecret)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OvhClientOAuth2.
func (in *OvhClientOAuth2) DeepCopy() *OvhClientOAuth2 {
	if in == nil {
		return nil
	}
	out := new(OvhClientOAuth2)
