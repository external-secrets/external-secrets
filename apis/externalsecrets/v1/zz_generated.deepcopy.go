...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SAPCSAuth) DeepCopyInto(out *SAPCSAuth) {
	*out = *in
	if in.OAuth2 != nil {
		in, out := &in.OAuth2, &out.OAuth2
		*out = new(SAPCSOAuth2Auth)
		(*in).DeepCopyInto(*out)
	}
	if in.MTLS != nil {
		in, out := &in.MTLS, &out.MTLS
		*out = new(SAPCSMTLSAuth)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SAPCSAuth.
func (in *SAPCSAuth) DeepCopy() *SAPCSAuth {
	if in == nil {
		return nil
	}
	out := new(SAPCSAuth)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SAPCSEncryption) DeepCopyInto(out *SAPCSEncryption) {
	*out = *in
	in.ClientPrivateKey.DeepCopyInto(&out.ClientPrivateKey)
	in.ServerPublicKey.DeepCopyInto(&out.ServerPublicKey)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SAPCSEncryption.
func (in *SAPCSEncryption) DeepCopy() *SAPCSEncryption {
	if in == nil {
		return nil
	}
	out := new(SAPCSEncryption)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SAPCSMTLSAuth) DeepCopyInto(out *SAPCSMTLSAuth) {
	*out = *in
	in.Certificate.DeepCopyInto(&out.Certificate)
	in.PrivateKey.DeepCopyInto(&out.PrivateKey)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SAPCSMTLSAuth.
func (in *SAPCSMTLSAuth) DeepCopy() *SAPCSMTLSAuth {
	if in == nil {
		return nil
	}
	out := new(SAPCSMTLSAuth)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SAPCSOAuth2Auth) DeepCopyInto(out *SAPCSOAuth2Auth) {
	*out = *in
	in.ClientID.DeepCopyInto(&out.ClientID)
	in.ClientSecret.DeepCopyInto(&out.ClientSecret)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SAPCSOAuth2Auth.
func (in *SAPCSOAuth2Auth) DeepCopy() *SAPCSOAuth2Auth {
	if in == nil {
		return nil
	}
	out := new(SAPCSOAuth2Auth)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SAPCSServiceBindingRef) DeepCopyInto(out *SAPCSServiceBindingRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SAPCSServiceBindingRef.
func (in *SAPCSServiceBindingRef) DeepCopy() *SAPCSServiceBindingRef {
	if in == nil {
		return nil
	}
	out := new(SAPCSServiceBindingRef)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SAPCredentialStoreProvider) DeepCopyInto(out *SAPCredentialStoreProvider) {
	*out = *in
	in.Auth.DeepCopyInto(&out.Auth)
	...
	if in.ServiceBindingSecretRef != nil {
		in, out := &in.ServiceBindingSecretRef, &out.ServiceBindingSecretRef
		*out = new(SAPCSServiceBindingRef)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SAPCredentialStoreProvider.
func (in *SAPCredentialStoreProvider) DeepCopy() *SAPCredentialStoreProvider {
	if in == nil {
		return nil
	}
	out := new(SAPCredentialStoreProvider)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecretStoreProvider) DeepCopyInto(out *SecretStoreProvider) {
	*out = *in
	...
	if in.SAPCredentialStore != nil {
		in, out := &in.SAPCredentialStore, &out.SAPCredentialStore
		*out = new(SAPCredentialStoreProvider)
		(*in).DeepCopyInto(*out)
	}
}
