...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VaultCustomHeader) DeepCopyInto(out *VaultCustomHeader) {
	*out = *in
	if in.Value != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VaultCustomHeader.
func (in *VaultCustomHeader) DeepCopy() *VaultCustomHeader {
	if in == nil {
		return nil
	}
	out := new(VaultCustomHeader)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VaultProvider) DeepCopyInto(out *VaultProvider) {
	*out = *in
	...
	if in.Headers != nil {
		...
		*out = make(map[string]VaultCustomHeader, len(*in))
		for key, val := range *in {
