...
func (in *AwsAuthCredentials) DeepCopyInto(out *AwsAuthCredentials) {
	*out = *in
	if in.IdentityID != nil {
		...
		*out = new(InfisicalProviderSecretRef)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InfisicalProviderSecretRef) DeepCopyInto(out *InfisicalProviderSecretRef) {
	*out = *in
	if in.SecretRef != nil {
		in, out := &in.SecretRef, &out.SecretRef
		*out = new(apismetav1.SecretKeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InfisicalProviderSecretRef.
func (in *InfisicalProviderSecretRef) DeepCopy() *InfisicalProviderSecretRef {
	if in == nil {
		return nil
	}
	out := new(InfisicalProviderSecretRef)
