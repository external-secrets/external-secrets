...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BarbicanProviderRef) DeepCopyInto(out *BarbicanProviderRef) {
	*out = *in
	if in.SecretRef != nil {
		in, out := &in.SecretRef, &out.SecretRef
		*out = new(apismetav1.SecretKeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BarbicanProviderRef.
func (in *BarbicanProviderRef) DeepCopy() *BarbicanProviderRef {
	if in == nil {
		return nil
	}
	out := new(BarbicanProviderRef)
	in.DeepCopyInto(out)
	return out
}
