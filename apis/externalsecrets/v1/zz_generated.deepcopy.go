...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BeyondtrustSecretAuth) DeepCopyInto(out *BeyondtrustSecretAuth) {
	*out = *in
	in.APIKey.DeepCopyInto(&out.APIKey)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BeyondtrustSecretAuth.
func (in *BeyondtrustSecretAuth) DeepCopy() *BeyondtrustSecretAuth {
	if in == nil {
		return nil
	}
	out := new(BeyondtrustSecretAuth)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BeyondtrustSecretAuthSecretRef) DeepCopyInto(out *BeyondtrustSecretAuthSecretRef) {
	*out = *in
	in.Token.DeepCopyInto(&out.Token)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BeyondtrustSecretAuthSecretRef.
func (in *BeyondtrustSecretAuthSecretRef) DeepCopy() *BeyondtrustSecretAuthSecretRef {
	if in == nil {
		return nil
	}
	out := new(BeyondtrustSecretAuthSecretRef)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BeyondtrustSecretsProvider) DeepCopyInto(out *BeyondtrustSecretsProvider) {
	*out = *in
	if in.Auth != nil {
		in, out := &in.Auth, &out.Auth
		*out = new(BeyondtrustSecretAuth)
	...
	if in.Server != nil {
		in, out := &in.Server, &out.Server
		*out = new(BeyondtrustSecretsServer)
		**out = **in
	}
	if in.CABundle != nil {
		in, out := &in.CABundle, &out.CABundle
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BeyondtrustSecretsProvider.
func (in *BeyondtrustSecretsProvider) DeepCopy() *BeyondtrustSecretsProvider {
	if in == nil {
		return nil
	}
	out := new(BeyondtrustSecretsProvider)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BeyondtrustSecretsServer) DeepCopyInto(out *BeyondtrustSecretsServer) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BeyondtrustSecretsServer.
func (in *BeyondtrustSecretsServer) DeepCopy() *BeyondtrustSecretsServer {
	if in == nil {
		return nil
	}
	out := new(BeyondtrustSecretsServer)
...
func (in *SecretStoreProvider) DeepCopyInto(out *SecretStoreProvider) {
	*out = *in
	...
	if in.BeyondtrustSecrets != nil {
		in, out := &in.BeyondtrustSecrets, &out.BeyondtrustSecrets
		*out = new(BeyondtrustSecretsProvider)
		(*in).DeepCopyInto(*out)
	}
	if in.CloudruSM != nil {
