...
func (in *OpenBaoJwtAuth) DeepCopyInto(out *OpenBaoJwtAuth) {
	*out = *in
	...
	if in.KubernetesServiceAccountToken != nil {
		...
		*out = new(OpenBaoKubernetesServiceAccountTokenAuth)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenBaoKubernetesServiceAccountTokenAuth) DeepCopyInto(out *OpenBaoKubernetesServiceAccountTokenAuth) {
	*out = *in
	in.ServiceAccountRef.DeepCopyInto(&out.ServiceAccountRef)
	if in.Audiences != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenBaoKubernetesServiceAccountTokenAuth.
func (in *OpenBaoKubernetesServiceAccountTokenAuth) DeepCopy() *OpenBaoKubernetesServiceAccountTokenAuth {
	if in == nil {
		return nil
	}
	out := new(OpenBaoKubernetesServiceAccountTokenAuth)
