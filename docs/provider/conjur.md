...
* `hostId` (optional) - The Secrets Manager host identity to authenticate as. Leave empty to use SPIFFE mode, where the host identity is derived from the certificate's CN/SAN.
