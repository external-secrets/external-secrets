...
This serves to define how we deal with potential security issues, from acknowledgement to publication.

## Sensitive work

### A quick classification of the issue: triaging

Triaging issues allows maintainers to focus resources on the most critically
impacting problems.

Potential security risks need to be evaluated against the
...
Notify the reporter (written evidence) that:

- you have received the issue
- you are reviewing the problem
