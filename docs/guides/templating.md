...
| certsToPkcs12    | Takes a PEM encoded certificates and creates a base64 encoded PKCS#12 archive.                                                                                                                                         |
| certsToPkcs12Pass| Same as `certsToPkcs12`. Uses the provided password to encrypt the PKCS#12 archive.                                                                                                                                            |
