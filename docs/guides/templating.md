...
| urlQueryEscape            | Takes a string and returns the escaped string so it can be safely placed inside a URL query. See [go net/url QueryEscape](https://pkg.go.dev/net/url#QueryEscape) for details.                                                                                                                                                                                                                                |
| urlPathEscape             | Takes a string and returns the escaped string so it can be safely placed inside a URL path segment. See [go net/url PathEscape](https://pkg.go.dev/net/url#PathEscape) for details.                                                                                                                                                                                                                           |
