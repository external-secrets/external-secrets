...
// Package serviceaccount provides functionality for ServiceAccountToken generator issues short-lived Kubernetes ServiceAccount tokens via the TokenRequest API.
...
// Generator implements ServiceAccountToken generator issues short-lived Kubernetes ServiceAccount tokens via the TokenRequest API functionality.
...
func (g *Generator) Generate(_ context.Context, jsonSpec *apiextensions.JSON, _ client.Client, _ string) (map[string][]byte, genv1alpha1.GeneratorProviderState, error) {
	...
	return map[string][]byte{
		"result": []byte("TODO: implement serviceaccount generator"),
	}, nil, nil
}
