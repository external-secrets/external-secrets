...
require (
	...
	github.com/external-secrets/external-secrets/providers/v1/aws v0.0.0-20260713095151-d0f709714e0a // indirect
	github.com/external-secrets/external-secrets/providers/v1/gcp v0.0.0-20260713095151-d0f709714e0a // indirect
