...
// Package main provides the GCP provider configuration and spec mapper implementation.
package main
...
// GetSpecMapper returns the spec mapper function for the GCP provider.
...
func GetSpecMapper(kubeClient client.Client) func(*pb.ProviderReference, string) (*v1.SecretStoreSpec, error) {
	return func(ref *pb.ProviderReference, sourceNamespace string) (*v1.SecretStoreSpec, error) {
		...
		var provider gcpsmv2alpha1.SecretManager
		...
		return &v1.SecretStoreSpec{
			Provider: &v1.SecretStoreProvider{
				GCPSM: &v1.GCPSMProvider{
					ProjectID: provider.Spec.ProjectID,
					Location:  provider.Spec.Location,
