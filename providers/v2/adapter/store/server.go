...
func (s *Server) getReadClient(ctx context.Context, providerRef *pb.ProviderReference, sourceNamespace string) (esv1.SecretsClient, error) {
	if err := validateProviderReference(providerRef); err != nil {
		return nil, err
	}
