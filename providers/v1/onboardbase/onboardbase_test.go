...
import (
	...
	"github.com/external-secrets/external-secrets/providers/v1/onboardbase/client"
	"github.com/external-secrets/external-secrets/providers/v1/onboardbase/fake"
)
