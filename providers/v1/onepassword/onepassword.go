...
const (
	...
	errOnePasswordStore                           = "received invalid 1Password SecretStore resource: %w"                          // sonar-resolve go:S2068 "false positive, this is error text"
	errOnePasswordStoreNilSpec                    = "nil spec"                                                                     // sonar-resolve go:S2068 "false positive, this is error text"
	errOnePasswordStoreNilSpecProvider            = "nil spec.provider"                                                            // sonar-resolve go:S2068 "false positive, this is error text"
	errOnePasswordStoreNilSpecProviderOnePassword = "nil spec.provider.onepassword"                                                // sonar-resolve go:S2068 "false positive, this is error text"
	errOnePasswordStoreMissingRefName             = "missing: spec.provider.onepassword.auth.secretRef.connectTokenSecretRef.name" // sonar-resolve go:S2068 "false positive, this is error text"
	errOnePasswordStoreMissingRefKey              = "missing: spec.provider.onepassword.auth.secretRef.connectTokenSecretRef.key"  // sonar-resolve go:S2068 "false positive, this is error text"
	errOnePasswordStoreAtLeastOneVault            = "must be at least one vault: spec.provider.onepassword.vaults"                 // sonar-resolve go:S2068 "false positive, this is error text"
	errOnePasswordStoreInvalidConnectHost         = "unable to parse URL: spec.provider.onepassword.connectHost: %w"               // sonar-resolve go:S2068 "false positive, this is error text"
	errOnePasswordStoreNonUniqueVaultNumbers      = "vault order numbers must be unique"                                           // sonar-resolve go:S2068 "false positive, this is error text"
