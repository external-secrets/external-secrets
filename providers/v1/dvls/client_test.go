...
func (m *mockCredentialClient) GetByID(_, entryID string) (dvls.Entry, error) {
	if m.getErr != nil {
...
func (m *mockCredentialClient) Update(entry dvls.Entry) (dvls.Entry, error) {
	if m.updateErr != nil {
...
func (m *mockCredentialClient) DeleteByID(_, entryID string) error {
	if m.deleteErr != nil {
		return m.deleteErr
	}
