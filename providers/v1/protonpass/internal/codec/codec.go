...
// reservedKeys are produced by the typed projections; user-defined extra
// fields with these names are dropped rather than overwriting the typed value.
var reservedKeys = map[string]struct{}{
	"title": {}, "note": {}, "username": {}, "password": {}, "email": {}, "url": {},
}
...
func projectExtraField(b []byte, result map[string][]byte) {
	...
	if _, reserved := reservedKeys[string(name)]; reserved {
		return
	}
